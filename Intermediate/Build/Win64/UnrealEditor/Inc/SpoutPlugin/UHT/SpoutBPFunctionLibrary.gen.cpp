...
struct Z_Construct_UEnum_SpoutPlugin_ESpoutState_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ExistsNotRegistered.Comment", "// ER\n// Sender exists in the registry but is not registered with Spout yet.\n" },
		{ "ExistsNotRegistered.Name", "ESpoutState::ExistsNotRegistered" },
		{ "ExistsNotRegistered.ToolTip", "ER\nSender exists in the registry but is not registered with Spout yet." },
		{ "ExistsRegistered.Comment", "// Sender exists in the registry and is registered with Spout.\n" },
		{ "ExistsRegistered.Name", "ESpoutState::ExistsRegistered" },
		{ "ExistsRegistered.ToolTip", "Sender exists in the registry and is registered with Spout." },
		{ "ModuleRelativePath", "Public/SpoutBPFunctionLibrary.h" },
		{ "NotExistsNotRegistered.Comment", "// noER\n// Sender does not exist in the registry and is not registered with Spout.\n" },
		{ "NotExistsNotRegistered.Name", "ESpoutState::NotExistsNotRegistered" },
		{ "NotExistsNotRegistered.ToolTip", "noER\nSender does not exist in the registry and is not registered with Spout." },
		{ "NotExistsRegistered.Comment", "// EnoR\n// Sender does not exist in the registry but is registered with Spout (external).\n" },
		{ "NotExistsRegistered.Name", "ESpoutState::NotExistsRegistered" },
		{ "NotExistsRegistered.ToolTip", "EnoR\nSender does not exist in the registry but is registered with Spout (external)." },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "ESpoutState::ExistsRegistered", (int64)ESpoutState::ExistsRegistered },
		{ "ESpoutState::ExistsNotRegistered", (int64)ESpoutState::ExistsNotRegistered },
		{ "ESpoutState::NotExistsRegistered", (int64)ESpoutState::NotExistsRegistered },
		{ "ESpoutState::NotExistsNotRegistered", (int64)ESpoutState::NotExistsNotRegistered },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
}; // struct Z_Construct_UEnum_SpoutPlugin_ESpoutState_Statics 
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SpoutPlugin_ESpoutState_Statics::EnumParams = {
	...
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_SpoutPlugin_ESpoutState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_SpoutPlugin_ESpoutState_Statics::Enum_MetaDataParams)
};
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FSenderStruct); }
	static inline consteval int16 GetStructAlignment() { return alignof(FSenderStruct); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FSenderStruct constinit property declarations *********************
...
// ********** End ScriptStruct FSenderStruct constinit property declarations ***********************
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FSenderStruct;
class UScriptStruct* FSenderStruct::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FSenderStruct.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FSenderStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSenderStruct, (UObject*)Z_Construct_UPackage__Script_SpoutPlugin(), TEXT("SenderStruct"));
	}
	return Z_Registration_Info_UScriptStruct_FSenderStruct.OuterSingleton;
	}

// ********** Begin ScriptStruct FSenderStruct Property Definitions ********************************
...
// ********** End ScriptStruct FSenderStruct Property Definitions **********************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FSenderStruct.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FSenderStruct.InnerSingleton, Z_Construct_UScriptStruct_FSenderStruct_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FSenderStruct.InnerSingleton);
}
...
// ********** Begin Function CloseSender constinit property declarations ***************************
	static const UECodeGen_Private::FNamePropertyParams NewProp_SpoutName;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function CloseSender constinit property declarations *****************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function CloseSender Property Definitions **************************************
...
// ********** End Function CloseSender Property Definitions ****************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "CloseSender", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::SpoutBPFunctionLibrary_eventCloseSender_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function CreateTextureRenderTarget2D constinit property declarations ***********
	static const UECodeGen_Private::FIntPropertyParams NewProp_Width;
	static const UECodeGen_Private::FIntPropertyParams NewProp_Height;
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function CreateTextureRenderTarget2D constinit property declarations *************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function CreateTextureRenderTarget2D Property Definitions **********************
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D_Statics::NewProp_Format = { "Format", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SpoutBPFunctionLibrary_eventCreateTextureRenderTarget2D_Parms, Format), Z_Construct_UEnum_CoreUObject_EPixelFormat, METADATA_PARAMS(0, nullptr) }; // 1211336029
...
// ********** End Function CreateTextureRenderTarget2D Property Definitions ************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "CreateTextureRenderTarget2D", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D_Statics::SpoutBPFunctionLibrary_eventCreateTextureRenderTarget2D_Parms),
...
// ********** Begin Function GetMaxSenders constinit property declarations *************************
	static const UECodeGen_Private::FIntPropertyParams NewProp_Max;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function GetMaxSenders constinit property declarations ***************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function GetMaxSenders Property Definitions ************************************
...
// ********** End Function GetMaxSenders Property Definitions **************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "GetMaxSenders", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::SpoutBPFunctionLibrary_eventGetMaxSenders_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function GetSenderInfo constinit property declarations *************************
	static const UECodeGen_Private::FNamePropertyParams NewProp_SpoutName;
	static const UECodeGen_Private::FStructPropertyParams NewProp_OutSenderStruct;
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function GetSenderInfo constinit property declarations ***************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function GetSenderInfo Property Definitions ************************************
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::NewProp_OutSenderStruct = { "OutSenderStruct", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SpoutBPFunctionLibrary_eventGetSenderInfo_Parms, OutSenderStruct), Z_Construct_UScriptStruct_FSenderStruct, METADATA_PARAMS(0, nullptr) }; // 2042294586
...
// ********** End Function GetSenderInfo Property Definitions **************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "GetSenderInfo", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::SpoutBPFunctionLibrary_eventGetSenderInfo_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function SetMaxSenders constinit property declarations *************************
	static const UECodeGen_Private::FIntPropertyParams NewProp_Max;
	static const UECodeGen_Private::FIntPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SetMaxSenders constinit property declarations ***************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SetMaxSenders Property Definitions ************************************
...
// ********** End Function SetMaxSenders Property Definitions **************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "SetMaxSenders", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::SpoutBPFunctionLibrary_eventSetMaxSenders_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function SpoutInfo constinit property declarations *****************************
	...
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SpoutInfo constinit property declarations *******************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SpoutInfo Property Definitions ****************************************
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::NewProp_Senders_Inner = { "Senders", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSenderStruct, METADATA_PARAMS(0, nullptr) }; // 2042294586
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::NewProp_Senders = { "Senders", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SpoutBPFunctionLibrary_eventSpoutInfo_Parms, Senders), EArrayPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 2042294586
...
// ********** End Function SpoutInfo Property Definitions ******************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "SpoutInfo", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::SpoutBPFunctionLibrary_eventSpoutInfo_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function SpoutReceiver constinit property declarations *************************
	static const UECodeGen_Private::FNamePropertyParams NewProp_SpoutName;
	...
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SpoutReceiver constinit property declarations ***************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SpoutReceiver Property Definitions ************************************
...
// ********** End Function SpoutReceiver Property Definitions **************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "SpoutReceiver", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::SpoutBPFunctionLibrary_eventSpoutReceiver_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver_Statics::Function_MetaDataParams)},  };
...
DEFINE_FUNCTION(USpoutBPFunctionLibrary::execSpoutReceiver)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=USpoutBPFunctionLibrary::SpoutReceiver(Z_Param_SpoutName,P_ARG_GC_BARRIER(Z_Param_Out_OutMat),P_ARG_GC_BARRIER(Z_Param_Out_OutTexture),Z_Param_OptionalOutputRenderTarget);
	P_NATIVE_END;
}
...
// ********** Begin Function SpoutSender constinit property declarations ***************************
	static const UECodeGen_Private::FNamePropertyParams NewProp_SpoutName;
	...
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SpoutSender constinit property declarations *****************************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SpoutSender Property Definitions **************************************
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::NewProp_SendTextureFrom = { "SendTextureFrom", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SpoutBPFunctionLibrary_eventSpoutSender_Parms, SendTextureFrom), Z_Construct_UEnum_SpoutPlugin_ESpoutSendTextureFrom, METADATA_PARAMS(0, nullptr) }; // 2908007197
...
// ********** End Function SpoutSender Property Definitions ****************************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_USpoutBPFunctionLibrary, nullptr, "SpoutSender", 	Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::SpoutBPFunctionLibrary_eventSpoutSender_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::Function_MetaDataParams), Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender_Statics::Function_MetaDataParams)},  };
...
FClassRegistrationInfo Z_Registration_Info_UClass_USpoutBPFunctionLibrary;
UClass* USpoutBPFunctionLibrary::GetPrivateStaticClass()
{
	using TClass = USpoutBPFunctionLibrary;
	if (!Z_Registration_Info_UClass_USpoutBPFunctionLibrary.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("SpoutBPFunctionLibrary"),
			Z_Registration_Info_UClass_USpoutBPFunctionLibrary.InnerSingleton,
			StaticRegisterNativesUSpoutBPFunctionLibrary,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_USpoutBPFunctionLibrary.InnerSingleton;
}
UClass* Z_Construct_UClass_USpoutBPFunctionLibrary_NoRegister()
{
	return USpoutBPFunctionLibrary::GetPrivateStaticClass();
}
...
// ********** Begin Class USpoutBPFunctionLibrary constinit property declarations ******************
// ********** End Class USpoutBPFunctionLibrary constinit property declarations ********************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("CloseSender"), .Pointer = &USpoutBPFunctionLibrary::execCloseSender },
		{ .NameUTF8 = UTF8TEXT("CreateTextureRenderTarget2D"), .Pointer = &USpoutBPFunctionLibrary::execCreateTextureRenderTarget2D },
		{ .NameUTF8 = UTF8TEXT("GetMaxSenders"), .Pointer = &USpoutBPFunctionLibrary::execGetMaxSenders },
		{ .NameUTF8 = UTF8TEXT("GetSenderInfo"), .Pointer = &USpoutBPFunctionLibrary::execGetSenderInfo },
		{ .NameUTF8 = UTF8TEXT("SetMaxSenders"), .Pointer = &USpoutBPFunctionLibrary::execSetMaxSenders },
		{ .NameUTF8 = UTF8TEXT("SpoutInfo"), .Pointer = &USpoutBPFunctionLibrary::execSpoutInfo },
		{ .NameUTF8 = UTF8TEXT("SpoutReceiver"), .Pointer = &USpoutBPFunctionLibrary::execSpoutReceiver },
		{ .NameUTF8 = UTF8TEXT("SpoutSender"), .Pointer = &USpoutBPFunctionLibrary::execSpoutSender },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_CloseSender, "CloseSender" }, // 2458359349
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_CreateTextureRenderTarget2D, "CreateTextureRenderTarget2D" }, // 3461899141
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_GetMaxSenders, "GetMaxSenders" }, // 4276643742
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_GetSenderInfo, "GetSenderInfo" }, // 1092516464
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_SetMaxSenders, "SetMaxSenders" }, // 549838944
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutInfo, "SpoutInfo" }, // 2758231871
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutReceiver, "SpoutReceiver" }, // 166680382
		{ &Z_Construct_UFunction_USpoutBPFunctionLibrary_SpoutSender, "SpoutSender" }, // 574935882
	};
...
void USpoutBPFunctionLibrary::StaticRegisterNativesUSpoutBPFunctionLibrary()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_USpoutBPFunctionLibrary_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, USpoutBPFunctionLibrary);
USpoutBPFunctionLibrary::~USpoutBPFunctionLibrary() {}
// ********** End Class USpoutBPFunctionLibrary ****************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESpoutType_StaticEnum, TEXT("ESpoutType"), &Z_Registration_Info_UEnum_ESpoutType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4161917643U) },
		{ ESpoutState_StaticEnum, TEXT("ESpoutState"), &Z_Registration_Info_UEnum_ESpoutState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1177488101U) },
		{ ESpoutSendTextureFrom_StaticEnum, TEXT("ESpoutSendTextureFrom"), &Z_Registration_Info_UEnum_ESpoutSendTextureFrom, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2908007197U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FSenderStruct::StaticStruct, Z_Construct_UScriptStruct_FSenderStruct_Statics::NewStructOps, TEXT("SenderStruct"),&Z_Registration_Info_UScriptStruct_FSenderStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSenderStruct), 2042294586U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USpoutBPFunctionLibrary, USpoutBPFunctionLibrary::StaticClass, TEXT("USpoutBPFunctionLibrary"), &Z_Registration_Info_UClass_USpoutBPFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpoutBPFunctionLibrary), 303837046U) },
	};
}; // Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_4178793009{
	TEXT("/Script/SpoutPlugin"),
	Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Experiments_55_Plugins_SpoutPlugin_Source_SpoutPlugin_Public_SpoutBPFunctionLibrary_h__Script_SpoutPlugin_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
